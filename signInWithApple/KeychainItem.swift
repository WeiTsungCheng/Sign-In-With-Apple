...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "WeiTsungCheng.signInWithApple1987", account: "userCredential").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "WeiTsungCheng.signInWithApple1987", account: "userCredential").deleteItem()
        } catch {
